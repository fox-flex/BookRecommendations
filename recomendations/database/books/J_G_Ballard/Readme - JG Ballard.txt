...
The British Library 'JG Ballard' dataset is a set of .csv (comma separated value) files containing metadata for resources relating to the author James Graham Ballard, from the British National Bibliography (BNB) and our British Library collections. It is updated annually on the anniversary of Ballard's birth in November 1930.
